...
- If a closed execution-doc is superseded by a new active subplan, the current-plan percentage must come from the newest active execution-doc rather than the historical closed plan.
