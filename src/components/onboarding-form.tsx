  ...
  function submit() {
    ...
    startTransition(async () => {
      try {
        ...
        if (!response.ok) {
          setError(payload?.message ?? "Не удалось сохранить онбординг.");
          return;
        }

        setNotice("Профиль сохранён. Перехожу в продукт.");
        ...
        <div className="mb-6 flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-semibold text-foreground">
              Заполни базовый контекст для тренировок, питания и AI
            </h2>
          </div>
        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <label className="grid gap-2 text-sm text-muted md:col-span-2">
            ...
            <textarea
              ...
              placeholder="Например: без лактозы, высокобелковое питание"
