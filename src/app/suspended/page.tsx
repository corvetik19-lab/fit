...
export default async function SuspendedPage() {
  ...
  return (
    <main className="min-h-screen bg-[radial-gradient(circle_at_top,_rgba(14,165,233,0.16),_transparent_38%),linear-gradient(180deg,_#f7fbff_0%,_#eef5ff_100%)] px-6 py-10 text-foreground">
      <div className="mx-auto grid min-h-[calc(100vh-5rem)] max-w-2xl content-center gap-6">
        <section className="card p-8 md:p-10">
          ...
          <p className="mt-4 text-sm leading-7 text-muted">
            ...
            сейчас находится в suspended state. Основной интерфейс приложения скрыт до
            решения вопроса поддержкой.
          </p>

          <div className="mt-6 grid gap-3 rounded-3xl border border-border bg-white/70 p-5 text-sm">
